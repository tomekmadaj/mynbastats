    ...
    private function createGameLeader($leader, $gameId, $gameDate, $teamId)
    {
        $result = DB::transaction(function () use ($leader, $gameId, $gameDate, $teamId) {
            $leader = [
                ...
                'rebounds' => $leader['points']['value'] ?? null,
                'rPersonId' => $leader['points']['players'][0]['personId'] ?? null,
                'rFirstName' => $leader['points']['players'][0]['firstName'] ?? null,
                'rLastName' => $leader['points']['players'][0]['lastName'] ?? null,
                'assists' => $leader['points']['value'] ?? null,
                'aPersonId' => $leader['points']['players'][0]['personId'] ?? null,
                'aFirstName' => $leader['points']['players'][0]['firstName'] ?? null,
                'aLastName' => $leader['points']['players'][0]['lastName'] ?? null,
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ];
